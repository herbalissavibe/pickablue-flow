...
export function AppShowcaseSection() {
  return (
    <Section
      ...
      className="relative overflow-hidden bg-gradient-to-br from-[#002b49] via-teal-mid to-[#00a3c1] py-16 text-white sm:py-20 lg:py-24"
    >
      <div
      ...
      <Container className="relative grid gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
        <div>
          ...
          <p className="mt-6 max-w-xl text-base leading-relaxed text-white/95 sm:text-lg">
